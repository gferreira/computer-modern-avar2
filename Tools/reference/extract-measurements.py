...
parametricAxes = {
    'Roman'  : ['XOPQ', 'XTRA', 'YOPQ', 'XTSA', 'XSHA', 'YSHA', 'XSVA', 'YSVA', 'YTUC', 'YTLC', 'YTAS', 'YTDE', 'BRKT', 'CUPS' 'WDSP'],
    'Italic' : ['XOPQ', 'XTRA', 'YOPQ', 'XTSA', 'XSHA', 'YSHA', 'XSVA', 'YSVA', 'YTUC', 'YTLC', 'YTAS', 'YTDE', 'CUPS', 'WDSP'], # 'YTUC', 'YTLC'
}
